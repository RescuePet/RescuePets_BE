...
public interface PostRepository extends JpaRepository<Post, Long>{
    ...
    @Query(value = "SELECT * FROM post WHERE post.post_type = :postType AND post.upkind = :searchValue AND ST_DISTANCE_SPHERE(POINT(:memberLatitude, :memberLongitude), POINT(post.happen_longitude, post.happen_latitude)) <= :distance ORDER BY post.created_at DESC", nativeQuery = true)
